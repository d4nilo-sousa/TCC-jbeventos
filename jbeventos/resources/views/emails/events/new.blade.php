...
Temos **novidades**! Um novo evento foi publicado no curso que você segue:

@foreach($event->courses as $course)
    <p style="font-size: 16px; font-weight: bold;">Curso: {{ $course->course_name }}</p>
@endforeach
