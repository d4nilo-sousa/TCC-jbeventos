...
<img src="{{ asset('storage/' . $event->event_image) }}" 
     ...
     style="width:100%; max-height:300px; object-fit:cover; margin-bottom:10px;">
@endif
...
<hr>
<h4 style="font-size:16px; font-weight:bold; margin-top:8px; margin-bottom:6px;">O que mudou?</h4>
<ul style="font-size:14px; color:#374151; padding-left:16px;">
    @foreach($changedFields as $field => $value)
        @php
            // Exibe o campo de forma amigável
            $label = [
                'event_name' => 'Nome do Evento',
                'event_scheduled_at' => 'Data do Evento',
...
Fique atento para não perder nenhuma atualização!  
{{ config('app.name') }}
@endcomponent
