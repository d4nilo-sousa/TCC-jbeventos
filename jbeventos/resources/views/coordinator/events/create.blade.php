                ...
                @else
                    ...
                    <form action="{{ isset($event) ? route('events.update', $event->id) : route('events.store') }}"
                        ...
                        <div>
                            ...
                            <div id="event_image_preview" class="mt-2 grid grid-cols-2 md:grid-cols-4 gap-2"></div>
                        </div>

                        {{-- Outras imagens (carrossel) --}}
                        <div>
                            ...
                            <input type="file" name="event_images[]" id="event_images" accept="image/*"
                                class="w-full border-gray-300 rounded shadow-sm" multiple>
                                
                            <div id="event_images_preview" class="mt-2 grid grid-cols-2 md:grid-cols-4 gap-2"></div>
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="hidden" name="coordinator_name"
                        ...
                        @if (auth()->user()->coordinator->coordinator_type === 'course')
                            <div class="mb-4">
                                ...
                                <x-text-input id="course_name" type="text" class="block mt-1 w-full bg-gray-100"
                                    ...
                                    readonly disabled />
                                <input type="hidden" name="coordinator_course"
