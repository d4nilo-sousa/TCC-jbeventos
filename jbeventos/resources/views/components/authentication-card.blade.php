<div class="min-h-screen flex overflow-hidden">
    ...
    <div x-data="{ show: false }" x-init="setTimeout(() => show = true, 100)" x-show="show"
        ...
        <div
            ...
            @if (Route::is('login'))
                <h2 class="text-3xl font-black mb-3 font-ubuntu">Novo por aqui?</h2>
            ...
            @elseif (Route::is('register'))
                <h2 class="text-3xl font-bold font-ubuntu mb-3">Já possui uma conta?</h2>
                ...
                <a href="{{ route('login') }}"
                    class="inline-block bg-red-700 text-white font-semibold px-6 py-2 rounded-full hover:bg-red-800 transition">
                    Fazer login
                </a>
            @endif
        </div>
