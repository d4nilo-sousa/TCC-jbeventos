{{-- NOVO: Este <div> é o container que o JavaScript do Echo usará para REMOVER o card. --}}
<div id="event-card-{{ $event->id }}">

    {{-- O link agora está DENTRO do <div> com o ID --}}
            ...
            <div class="relative w-full h-48 rounded-md overflow-hidden mb-4">
                ...
                @if (
                    $loggedCoordinator &&
                        ...
                        $loggedCoordinator->id === $event->eventCoordinator->user_account_id)
