        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div id="coursesList" data-url="{{ route('courses.index') }}"
                ...
                @forelse ($courses as $course)
                    {{-- Os cards tem background branco individual --}}
                    @include('partials.courses.course-card', ['course' => $course])
                @empty
                    {{-- Mensagem de Vazio - AGORA TEMPORARIAMENTE SEM FUNDO BRANCO E SOMBRA AQUI --}}
                    {{-- Vamos confiar que o JS de busca não interfere adicionando o container externo --}}
                    <div id="noCoursesMessage"
                        class="col-span-full flex flex-col items-center justify-center gap-6 text-center w-full my-10 p-16">
                        
                        {{-- A Imagem aparecerá diretamente no fundo cinza --}}
