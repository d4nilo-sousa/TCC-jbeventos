    ...
    {{ in_array($user->user_icon_default, ['avatar_default_1.svg', 'avatar_default_2.svg']) ? 'bg-gray-200' : 'bg-white' }}">
        ...
        flex items-center">
                                ...
                                <div x-show="activeTab === 'savedEvents'">
                                    ...
                                    @else
                                        {{-- CONTÊINER COM 2 COLUNAS FIXAS --}}
                                        <div
                                            class="max-h-[800px] overflow-y-auto grid grid-cols-1 md:grid-cols-2 gap-6 pb-4">
                    ...
                    <div class="lg:col-span-1 space-y-6">
                        ...
                        <div class="bg-white p-6 rounded-xl shadow-lg border border-gray-100">
                            <h3 class="text-xl font-bold mb-4 text-gray-800 flex items-center">
                                <i class="ph ph-identification-card text-2xl mr-2 text-red-500"></i> Detalhes da
                                Conta
                            </h3>
                                ...
                                @if ($user->user_type === 'admin')
                                    <div class="flex items-start">
                                        ...
                                        <div class="flex-1">
                                            ...
                                            <p class="text-sm font-medium text-gray-700">Responsável pelo
                                                Gerenciamento
                                                do Sistema</p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="flex items-start">
                                        ...
                                        <div class="flex-1">
                                            @if ($coordinator->coordinator_type === 'general')
                                                ...
                                                <p class="text-sm font-medium text-gray-700">Responsável pelos
                                                    Eventos
                                                    Gerais</p>
