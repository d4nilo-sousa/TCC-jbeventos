        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8" x-data="{ activeTab: '{{ request('tab', 'biography') }}' }">
                ...
                <div class="px-6 py-4">
                    <div class="border-b border-gray-200">
                        <nav class="-mb-px flex space-x-8" aria-label="Tabs">
                            ...
                            <button @click="activeTab = 'settings'" :class="{'border-red-500 text-red-600': activeTab === 'settings', 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300': activeTab !== 'settings'}" class="whitespace-nowrap py-4 px-1 border-b-2 font-medium text-sm transition-colors duration-200 flex items-center">
                    ...
                    <div class="mt-8">
                        ...
                        {{-- CONTEÚDO DA ABA: Configurações (Jetstream) --}}
            ...
            <div class="lg:col-span-1 space-y-6">
                ...
                @if(auth()->id() === $user->id)
                    ...
                    {{-- Link para Edição Rápida (Se quiser direcionar o usuário para a aba de Configurações) --}}
                    <button @click="activeTab = 'settings'; window.scrollTo({ top: 0, behavior: 'smooth' })" class="w-full text-center text-red-600 font-medium hover:text-red-800 transition-colors duration-200 py-2">
                        <i class="ph ph-wrench text-lg mr-1"></i> Ir para Editar Perfil
                    </button>
                @endif
