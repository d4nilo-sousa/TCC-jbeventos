<form wire:submit.prevent="updateProfileInformation" class="space-y-4">
                    ...
                    <div class="flex flex-col space-y-1">
                        ...
                        @if ($this->user->profile_photo_path)
                            <x-secondary-button type="button" wire:click="deleteProfilePhoto"
                                class="!py-1.5 !px-3 text-xs text-red-500 hover:text-red-700">
    ...
    <div class="flex items-center justify-end pt-4 border-t border-gray-100">
        {{-- Mensagem de sucesso à esquerda --}}
        <x-action-message class="text-green-600 font-semibold inline-block min-w-[80px]" on="saved">
