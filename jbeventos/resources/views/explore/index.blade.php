        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-6">
                ...
                <div id="all-section" class="tab-content">
                    ...
                    <h3 class="text-2xl font-bold text-gray-700 mb-4 mt-8">Eventos Recentes</h3>
                    ...
                    <h3 class="text-2xl font-bold text-gray-700 mb-4 mt-8">Posts Recentes</h3>
                    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
                    ...
                    <h3 class="text-2xl font-bold text-gray-700 mb-4 mt-8">Cursos</h3>
                    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
                    ...
                    <h3 class="text-2xl font-bold text-gray-700 mb-4 mt-8">Coordenadores</h3>
                    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            if (activeTabParam && document.querySelector(`[data-tab="${activeTabParam}"]`)) {
                ...
                showContent('all'); // Define a aba 'Todos' como padrão
            }
