                                    ...
                                    <tr class="hover:bg-gray-50 transition-colors">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-center">
                                            <div class="inline-flex space-x-2">
                                                ...
                                                <button type="button" class="delete-button inline-flex items-center justify-center h-8 w-8 rounded-full text-red-600 hover:bg-red-100 transition-colors" title="Excluir" data-id="{{ $coordinator->id }}" data-name="{{ $coordinator->userAccount->name }}">
                                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
