        ...
        <div class="w-full max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="bg-white shadow-lg rounded-2xl p-6 sm:p-8 lg:p-12">
                ...
                <div class="flex flex-col items-center justify-center mb-10 text-center">
                    ...
                    <h1 class="text-3xl font-bold text-gray-800">Editar Coordenador</h1>
                    <p class="mt-2 text-gray-600">Atualize as informações do coordenador no sistema.</p>
                </div>
                ...
                <form action="{{ route('coordinators.update', $coordinator->id) }}" method="POST" class="space-y-6">
                    ...
                    <div>
                        ...
                        <select id="coordinator_type" name="coordinator_type" class="w-full border-gray-300 rounded-md shadow-sm focus:ring-red-500 focus:border-red-500" required>
                    ...
                    <div class="flex justify-end space-x-3 mt-8">
                        <a href="{{ route('coordinators.index') }}" class="inline-flex items-center px-6 py-2 border border-gray-300 rounded-full shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500 transition-all">
                            Cancelar
                        </a>
                        <button type="submit" class="inline-flex items-center px-6 py-2 border border-transparent rounded-full shadow-sm text-sm font-medium text-white bg-red-600 hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500 transition-all">
                            Atualizar
                        </button>
                    </div>
                </form>
